...
Route::middleware(['jwt.auth', 'isAdminSatker'])->group(function(){
    ...
    Route::get("list-majelis-hakim/{id_zonasi_satker_enc}", "api\zonasiSatkerController@getMajelisHakimSatker");
    ...
    Route::post("confirm-majelis-hakim", 'api\zonasiSatkerController@sendConfirmMajelisHakim')->middleware('checkSign');
...
Route::middleware(['jwt.auth', 'isAdminBadilum'])->group(function(){
    ...
    Route::get('detil-bobot/{id_jabatan_peserta}/{token_tingkat_satker}', 'api\configController@getDetilBobot');
...
Route::get('report-penilaian-personal/{key}', 'api\reportController@reportIndividualPersonal')->name('report-penilaian-personal');
