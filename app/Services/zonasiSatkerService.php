        ...
        public function saveMejelisHakim($nama_majelis, $id_hakim_arr, $id_zonasi_satker){
            ...
            try{
                ...
                if(!is_null($get_periode)){
                    ...
                    if(!$check_majelis){
                        $check_komposisi = Majelis_hakim::whereIn('IdObservee', $id_hakim_arr)->where('id_zonasi_satker', $id_zonasi_satker)->groupBy('nama_majelis')->havingRaw('COUNT(IdObservee) > ?', [3])->count();
