            ...
            foreach($get_satker_zonasi as $list_satker){
                ...
                foreach($get_jabatan_peserta as $list_jabatan_peserta){
                    ...
                    foreach($getPeserta as $list_peserta){
                        if((int)$list_peserta['id_kelompok_jabatan'] === (int)$list_jabatan_peserta['id_kelompok_jabatan'] && (int)$list_satker['IdZonaSatker'] === (int)$list_peserta['IdZonaSatker']){
                            ...
                            if($include === "true"){
                                Log::info($list_peserta['nama_pegawai']." : ".$list_peserta['id_kelompok_jabatan']." : ".$list_jabatan_peserta['id_kelompok_jabatan']." dan ".$list_satker['IdZonaSatker'].":".$list_peserta['IdZonaSatker']." masuk ke data peserta dengan index satker: ".$index_satker." dan variable: ".$variables);
                ...
                if((int)$list_satker['jumlah_panmud'] !== (int)$jlh_panmud){
                    ...
                    if($jumlah_panmud_not_exists !== $selisih){
                        return ['status'=>false, 'msg'=>"Jumlah Panmud tidak sesuai. Satker: ".$list_satker['NamaSatker'].". Jumlah Panmud yang tidak ada: ".$jumlah_panmud_not_exists.". Selisih Panmud :".$list_satker['jumlah_panmud']."-". (int)$jlh_panmud." = ".$selisih];
                    }
