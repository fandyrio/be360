    ...
    class reportService{
        ...
        public function generateDataReport($id_zonasi_satker, $id_zonasi, $id_periode_ctrl, $refesh){
            ...
            if((int)$id_periode_ctrl === $id_periode){
                ...
                //check apakai zonasi satker nya ada dan sudah kirim penilaian nya ke badilum
                if(!is_null($get_zonasi_satker) && (int)$get_zonasi_satker['kirim_penilaian'] === 1){
                    ...
                    $msg="Satker ini belum mengirimkan hasil penilaian";
                }
            }else{
